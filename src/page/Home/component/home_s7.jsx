...
const HomeS7 = () => {
    return (
        <div className="home_s7 pt-5 pb-5">
            <div className="row">
                <div data-aos="fade-up" className="col-3 s7_item">
                    <div className="s7_circle">
                        <svg xmlns="http://www.w3.org/2000/svg" width="37" height="36" viewBox="0 0 32 32" fill="none">
                            <path d="M8 16H4" stroke="black" stroke-width="1.5" stroke-linecap="round"
                                  stroke-linejoin="round"></path>
                            <path d="M7.99984 22.6667H6.6665" stroke="black" stroke-width="1.5" stroke-linecap="round"
                                  stroke-linejoin="round"></path>
                            <path d="M23.7719 24H30.6666V16L25.3333 13.3333L23.9999 8H13.3333V24H16.2279" stroke="black"
                                  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M1.33325 9.3335H7.99992" stroke="black" stroke-width="1.5" stroke-linecap="round"
                                  stroke-linejoin="round"></path>
                            <path d="M1.33325 2.66675H13.3333V8.00008" stroke="black" stroke-width="1.5"
                            ...
                            <path d="M18.6665 12V14.6667H21.3332" stroke="black" stroke-width="1.5"
                                  stroke-linecap="round" stroke-linejoin="round"></path>
                        </svg>
                    </div>
                ...
                <div data-aos="fade-up" className="col-3 s7_item">
                    <div className="s7_circle">
                        <svg xmlns="http://www.w3.org/2000/svg" width="37" height="36" viewBox="0 0 33 32" fill="none">
                            <path
                                d="M8.50004 4H4.50004C3.02671 4 1.83337 5.19333 1.83337 6.66667C1.83337 8.14 3.02671 9.33333 4.50004 9.33333"
                                stroke="#000000" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round"></path>
                            <path d="M8.5 9.33325V1.33325H27.1667V9.33325" stroke="#000000" stroke-width="1.5"
                                  stroke-linecap="round" stroke-linejoin="round"></path>
                            <path
                    ...
                    <div className="s7_circle">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="37" height="36" viewBox="0 0 37 36" fill="none">
                            <g clip-path="url(#clip0_174_981)">
                                <path d="M30.167 6.33301L23.804 12.696" stroke="black" stroke-width="1.5"
                                      stroke-linecap="round" stroke-linejoin="round"></path>
                                <path d="M30.167 29.667L23.804 23.304" stroke="black" stroke-width="1.5"
                                      stroke-linecap="round" stroke-linejoin="round"></path>
                                <path d="M6.83301 29.667L13.196 23.304" stroke="black" stroke-width="1.5"
                                      stroke-linecap="round" stroke-linejoin="round"></path>
                                <path d="M6.83301 6.33301L13.196 12.696" stroke="black" stroke-width="1.5"
                                      stroke-linecap="round" stroke-linejoin="round"></path>
                                <path
